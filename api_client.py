...
def transform_image_fal(image_url: str, effect: str, text_content: str = None) -> str:
    ...
    prompts = {
        ...
        "3d_price": "Add large 3D serif text floating in the center of the scene with shadow: {text}",
        "3d_city": "Add large 3D serif text floating in the center of the scene with shadow: {text}",
        "3d_beds": "Add large 3D serif text floating in the center of the scene with shadow: {text}",
    }
